...
function ImageCard(props) {
  return (
    <Link to={"/product_detail"}>
      <div className="relative max-w-xs overflow-hidden rounded-3xl shadow-lg group w-72 h-86">
        <img
          src={props.cardImg}
          alt=""
          className="transition-transform group-hover:scale-150 duration-200 w-full h-full object-cover"
        />
